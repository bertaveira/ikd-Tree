...
private:
    ...
    int Delete_by_range(
        KD_TREE_NODE ** root, BoxPointType boxpoint, bool allow_rebuild,
        bool is_downsample);
    ...
    void Search(
        KD_TREE_NODE * root, int k_nearest, PointType point, MANUAL_HEAP & q,
    ...
    void Search_by_radius(
        KD_TREE_NODE * root, PointType point, float radius,
        PointVector & Storage);
...
public:
    ...
    void InitializeKDTree(
        float delete_param = 0.5, float balance_param = 0.7,
